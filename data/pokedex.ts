export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Galar"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Galar"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
	...
	rotomgalar: {
		...
		abilities: {0: "Clear Body", 1: "Serene Grace", H: "Gestalt"},
		heightm: 0.8,
		weightkg: 22.7,
		color: "Brown",
		eggGroups: ["Field"],
